...
public class OptionSetCombinedMediaPropertiesPanel extends DesignElementPropertiesPanel
	implements
	...
	public OptionSetCombinedMediaPropertiesPanel(String name, IDesignElement element) {
		...
		screensByType = MediaConfigurationScreenManager.getInstance()
				.getIndexedMediaConfigurationScreens(primitiveElement.getSubTypeId(), this);
	}
	...
	public void createControls(Composite parent) {
		...
		variableField.addVerifyListener(new VerifyListener() {
			...
			public void verifyText(VerifyEvent e) {
				...
				if ("".equals(currentName)
						|| VariableNameValidator.followsVtpNamingRules(currentName)) {
		...
		if ("".equals(variableField.getText())
				|| VariableNameValidator.followsVtpNamingRules(variableField.getText())) {
