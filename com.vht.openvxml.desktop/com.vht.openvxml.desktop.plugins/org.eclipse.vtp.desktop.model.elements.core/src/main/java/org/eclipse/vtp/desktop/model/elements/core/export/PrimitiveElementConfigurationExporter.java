...
public class PrimitiveElementConfigurationExporter implements IConfigurationExporter {
	...
	public void exportConfiguration(IFlowElement flowElement, Element actionElement) {
		IConfigurationExporter exporter = primitiveExporters.get(flowElement.getProperties()
				.getProperty("type"));
		if (exporter != null) {
	...
	public String getActionId(IFlowElement flowElement) {
		IConfigurationExporter exporter = primitiveExporters.get(flowElement.getProperties()
				.getProperty("type"));
		if (exporter != null) { return exporter.getActionId(flowElement); }
		System.err.println("Unable to locate primitive exporter for "
				+ flowElement.getProperties().getProperty("type"));
	...
	public String getDefaultPath(IFlowElement flowElement) {
		IConfigurationExporter exporter = primitiveExporters.get(flowElement.getProperties()
				.getProperty("type"));
		if (exporter != null) { return exporter.getDefaultPath(flowElement); }
		return "Continue";
	}
	...
	public String translatePath(IFlowElement flowElement, String uiPath) {
		IConfigurationExporter exporter = primitiveExporters.get(flowElement.getProperties()
				.getProperty("type"));
		if (exporter != null) { return exporter.translatePath(flowElement, uiPath); }
		return uiPath;
	}
	...
	public String getTargetId(IFlowElement flowElement, Element afterTransitionElement) {
		IConfigurationExporter exporter = primitiveExporters.get(flowElement.getProperties()
				.getProperty("type"));
		if (exporter != null) { return exporter.getTargetId(flowElement, afterTransitionElement); }
	...
	public boolean isEntryPoint(IFlowElement flowElement) {
		IConfigurationExporter exporter = primitiveExporters.get(flowElement.getProperties()
				.getProperty("type"));
		if (exporter != null) { return exporter.isEntryPoint(flowElement); }
		return false;
	}
}
