...
public class BindingValue {
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.eclipse.vtp.desktop.core.configuration.generic.BindingItem#readConfiguration(org.w3c.
	 * dom.Element)
	 */
	public void readConfiguration(Element configuration) {
		...
		if (propertyValueElementList.getLength() > 0) {
			...
			if (VARIABLE.equalsIgnoreCase(valueTypeAtt)) valueType = VARIABLE;
			else if (EXPRESSION.equalsIgnoreCase(valueTypeAtt)) valueType = EXPRESSION;
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.eclipse.vtp.desktop.core.configuration.generic.BindingItem#writeConfiguration(org.w3c
	 * .dom.Element)
	 */
