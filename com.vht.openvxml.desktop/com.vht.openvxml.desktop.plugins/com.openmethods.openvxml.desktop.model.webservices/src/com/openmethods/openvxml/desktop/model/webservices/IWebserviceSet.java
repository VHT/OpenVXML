...
/**
 * This interface represents the folder resource of an application project that contains the
 * database configuration information file and folder resources.
 *
 * @author Trip Gilman
 * @version 2.0
 */
public interface IWebserviceSet extends IWorkflowResourceContainer {
	/**
	 * @return The list of <code>IDatabase</code>s that are defined in this application project
	 */
	...
	/**
	 * Creates a new database folder resource with the given name. The database will not initially
	 * contain any database table definitions.
	 *
	 * @param name The name of the database folder resource
	 * @return The newly created database folder resource
	 * @throws CoreException If an error occured during the creation of the required file or folder
	 *             resources of the database definition
	 */
	public IWebserviceDescriptor createWebserviceDescriptor(String name, InputStream content);

	/**
	 * Removes the given database from this application. This will also remove all database table
	 * definitions contained by the database folder resource.
	 *
