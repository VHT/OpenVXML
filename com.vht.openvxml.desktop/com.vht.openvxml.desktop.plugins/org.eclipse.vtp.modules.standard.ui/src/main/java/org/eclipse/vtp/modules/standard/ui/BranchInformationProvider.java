...
public class BranchInformationProvider extends PrimitiveInformationProvider {
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.eclipse.vtp.desktop.editors.core.elements.PrimitiveInformationProvider#acceptConnector
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.eclipse.vtp.desktop.editors.core.elements.PrimitiveInformationProvider#getConnectorRecord
	 * (java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.eclipse.vtp.desktop.editors.core.elements.PrimitiveInformationProvider#getConnectorRecords
	 * ()
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.eclipse.vtp.desktop.editors.core.elements.PrimitiveInformationProvider#readConfiguration
	 * (Element)
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.eclipse.vtp.desktop.editors.core.elements.PrimitiveInformationProvider#writeConfiguration
	 * (Element)
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.eclipse.vtp.desktop.editors.core.elements.PrimitiveInformationProvider#hasConnectors()
	 */
	...
	private void buildInitialConnectorRecords() {
		...
		connectorRecords.add(new ConnectorRecord(getElement(), "error.script",
				IDesignElementConnectionPoint.ConnectionPointType.ERROR_POINT));
		connectorRecords.add(new ConnectorRecord(getElement(), "Default",
				IDesignElementConnectionPoint.ConnectionPointType.EXIT_POINT));
		for (Branch br : branches) {
			ConnectorRecord cr = new ConnectorRecord(getElement(), br.getName(),
					IDesignElementConnectionPoint.ConnectionPointType.EXIT_POINT);
	...
	private List<Branch> updateConnectorRecords(List<Branch> updatedBranches) {
		...
		// look for deletions (exists in branches, but not updatedBranches); delete from
		// connectorRecords
		for (Branch br : branches) {
		...
		for (Branch ubr : updatedBranches) {
			...
			if (!(branchMap.containsKey(ubr.getGuid()))) {
				ConnectorRecord cr = new ConnectorRecord(getElement(), ubr.getName(),
						IDesignElementConnectionPoint.ConnectionPointType.EXIT_POINT);
				connectorRecords.add(cr);
				ubr.setConnector(cr);
			}
