...
public class BeginDialogInformationProvider extends PrimitiveInformationProvider {
	...
	public List<Variable> getOutgoingVariables(String exitPoint, boolean localOnly) {
		if (!localOnly) {
			...
			IDesignElement dialogElement = mainDesign.getDesignElement(getElement().getDesign()
					.getDesignId());
			if (dialogElement != null) { return mainDesign.getVariablesFor(dialogElement); }
		}
