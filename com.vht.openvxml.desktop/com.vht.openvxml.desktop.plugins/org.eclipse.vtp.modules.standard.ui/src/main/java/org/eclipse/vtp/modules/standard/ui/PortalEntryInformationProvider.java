...
public class PortalEntryInformationProvider extends PrimitiveInformationProvider
	implements
	...
	public void resolve() {
		...
		if (exitElement == null) {
			for (IDesignElement element : elements) {
				if (element.getAdapter(IDesignEntryPoint.class) != null
						&& element.getName().equals(exitName)) {
					this.exitElement = element;
