...
/**
 * This class contains the named bindings associated with an interaction type. Each interaction type
 * will likely have its own unique set of named bindings. There may be similarly named bindings
 * present in multiple interaction bindings but there is no guarantee that they are related in any
 * way.
 * 
 * @author trip
 */
public class InteractionBinding {
	...
	/**
	 * Creates a new interaction binding instance that is contained by the provided manager and
	 * associated with the interaction type with the given identifier.
	 * 
	...
	/**
	 * Retrieves the named binding with the given name. If no named binding is located, a new named
	 * binding instance is created with the given name and added to this interaction binding.
	 * 
	...
	/**
	 * Reads the configuration data stored in the given dom element into this interaction binding
	 * instance. Any previous information stored in this interaction binding is lost.
	 * 
	...
	public void writeConfiguration(Element interactionElement) {
		...
		while (iterator.hasNext()) {
			...
			Element namedBindingElement = interactionElement.getOwnerDocument().createElement(
					"named-binding");
