...
/**
 * This class records the details of which attached data point is being requested. It contains the
 * name of the data point as well as the location the value retrieved should be stored in.
 * 
 * @author trip
 */
public class AttachedDataItemEntry {
	...
	/**
	 * Sets the variable name the value of this attached data entry will be stored into.
	 * 
