...
/**
 * This class represents a named set of configuration bindings for attached data requests. Items and
 * their entries are stored as children to the binding based on the brand, interaction type, and
 * language.
 * 
 * @author trip
 */
public class AttachedDataBinding extends GenericBinding {
	...
	/*
	 * (non-Javadoc)
	 * @see org.eclipse.vtp.desktop.core.configuration.adrequest.GenericBinding# writeBindingItem
