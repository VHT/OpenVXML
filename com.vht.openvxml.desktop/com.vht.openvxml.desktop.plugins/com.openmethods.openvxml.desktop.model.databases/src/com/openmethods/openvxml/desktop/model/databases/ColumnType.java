...
/**
 * This class encapsulates the possible data types assigned to database table columns. Only the
 * standard SQL-92 types are supported.
 *
 * @author Trip Gilman
 * @version 2.0
 */
public class ColumnType {
	...
	/**
	 * A flag indicating wheather or not the column will automatically increase in value each time a
	 * new record is inserted into the table. Default is <code>false</code>.
	 */
	private boolean autoIncrement;

	/**
	 * Creates a new <code>ColumnType</code> with the given type name and data storage length.
	 *
	...
	/**
	 * Generates the XML DOM elements and attributes required to save the information for this
	 * column type.
	 *
	...
	/**
	 * Constructs a new <code>ColumnType</code> from the given type name, data length, nullable
	 * flag, and auto increment flag. This is the primary method of instanciating this class.
	 *
	 ...
	 * @param autoIncrement A flag indicating whether this column type will automatically increment
	 *            when new records are added to its database table
	 * @return A <code>ColumnType</code> instance representing the given column type information
	 */
	public static ColumnType custom(String typeName, int length, boolean nullable,
	...
	/**
	 * Constructs a new <code>ColumnType</code> from the information stored in the given XML DOM
	 ...
	 * @return The new <code>ColumnType</code> instance represented by the given column type
	 *         information
	 */
	public static ColumnType load(Element element) {
		if (!element.getTagName().equals("column-type")) { throw new IllegalArgumentException(
				"DesignElement Format Exception"); }

		String typeName = element.getAttribute("type");
		int length = Integer.parseInt(element.getAttribute("length"));
		ColumnType ret = new ColumnType(typeName, length);
		ret.nullable = Boolean.valueOf(element.getAttribute("nullable")).booleanValue();
		ret.autoIncrement = Boolean.valueOf(element.getAttribute("autoIncrement")).booleanValue();
