...
/**
 * This is a concrete implementation of <code>IDatabaseSet</code> and provides the default behavior
 * of that interface.
 *
 * @author Trip Gilman
 * @version 2.0
...
public class DatabaseSet extends WorkflowResource implements IDatabaseSet {
	...
	/**
	 * Creates a new <code>DatabaseSet</code> with the given application project and eclipse folder
	 * resource.
	 *
	...
	public IDatabase createDatabase(String name) throws CoreException {
		...
		if (databaseFolder.exists()) { throw new IllegalArgumentException(
		...
		workaround.create(new ByteArrayInputStream(
				"This is a workaround for Git's lack of empty directory support.".getBytes()),
				true, null);
	 ...
	 * (non-Javadoc)
	 * @see
	 * org.eclipse.vtp.desktop.core.project.IDatabaseSet#deleteDatabase(org.eclipse.vtp.desktop.
	 * core.project.IDatabase)
	 */
	...
	public boolean equals(Object obj) {
		if (obj instanceof DatabaseSet) { return folder.equals(((DatabaseSet) obj)
				.getUnderlyingFolder()); }
		return false;
	}
	...
	public Object getAdapter(@SuppressWarnings("rawtypes") Class adapterClass) {
		...
		if (DatabaseSet.class.isAssignableFrom(adapterClass)) return this;
