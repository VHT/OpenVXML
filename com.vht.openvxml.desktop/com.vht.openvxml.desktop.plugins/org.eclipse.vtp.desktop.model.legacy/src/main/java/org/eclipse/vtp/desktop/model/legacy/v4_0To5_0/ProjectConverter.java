	...
	public void convertProject(IProject project) {
		try {
			...
			if (project.hasNature(WorkflowProjectNature.NATURE_ID)
				...
				Element aspectsElement = rootElement.getOwnerDocument().createElement(
						"project-aspects");
				...
				dependenciesAspectElement.setAttribute("id",
				...
				businessObjectAspectElement.setAttribute("id",
				...
				workflowAspectElement.setAttribute("id",
				...
				brandAspectElement.setAttribute("id",
				...
				if (typeSupportElement != null) {
					...
					languageAspectElement.setAttribute("id",
				...
				if (mediaDefaultsElement != null) {
					...
					interactiveAspectElement.setAttribute("id",
