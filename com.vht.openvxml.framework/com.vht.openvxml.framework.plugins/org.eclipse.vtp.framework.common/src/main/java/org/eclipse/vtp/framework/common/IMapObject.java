...
public interface IMapObject extends IDataObject {
	...
	/**
	 * Removes the item mapped to the given key and also removes the key from the map as well.
	 * 
	 ...
	 */
	void removeElement(String key) throws IllegalStateException, IndexOutOfBoundsException;
}
