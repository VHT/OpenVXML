...
/**
 * The <code>ElseIf</code> class represents the &lt;elseif&gt; VXML element. It contains a list of
 * actions for the VXML interpreter to execute if its conditional expression evaluates to
 * <code>true</code>. The list of actions will be written to the VXML document in the order they
 * were added.<br>
 * <br>
 * For more information on the ElseIf class and its usage, see the JavaDoc of the If class.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
 * @version 2.0
...
public class ElseIf extends Widget implements VXMLConstants {
	...
	/**
	 * Creates a new instance of <code>ElseIf</code> with the specified conditional expression and
	...
	/**
	 * Adds the action to this else-if. The list of actions are written to the VXML document in the
	...
	public void writeWidget(ContentHandler outputHandler) throws NullPointerException, SAXException {
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_ELSEIF, NAME_ELSEIF, attributes);
