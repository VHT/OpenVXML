...
/**
 * The <code>Parameter</code> class represents the &lt;param&gt; VXML element. Certain VXML elements
 * require data to be passed in Parameter objects. The <code>Subdialog</code> element requires any
 * variables in the current dialog you want to perform operations on must be passed as Parameter
 * elements.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
...
public class Parameter extends Widget implements VXMLConstants {
	...
	public void writeWidget(ContentHandler outputHandler) throws NullPointerException, SAXException {
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_PARAM, NAME_PARAM, attributes);
