...
public class OutputSet extends Output {
	...
	/**
	 * Appends the <code>Output</code> to the list of outputs to render to the caller.
	 * 
	...
	/**
	 * Removes the <code>Output</code> from the list of outputs to render to the caller.
	 * 
