...
/**
 * The <code>Block</code> element is used to encapsulate an arbitrary set of actions to be executed
 * during the processing of a VXML <code>Form</code>. The actions are executed in the order in which
 * they are added to the <code>Block</code> instance. <code>Variable</code>s can also be declared in
...
public class Block extends FormElement {
	 ...
	 * 
	 * @param name The name of the block element.
	 * @param expression An expression that will set the initial value of the block element.
	 * @throws IllegalArgumentException If the specified name is empty.
	 ...
	 * @param name The name of the block element.
	 * @param expression An expression that will set the initial value of the block element.
	 * @param condition An expression that equates to a boolean value which determines if the block
	 *            will be executed.
	 * @throws IllegalArgumentException If the specified name is empty.
	 * @throws IllegalArgumentException If the specified expression is empty.
	 ...
	 * @throws NullPointerException If the specified name is <code>null</code>.
	 */
	public Block(String name, String expression, String condition) throws IllegalArgumentException,
			NullPointerException {
	...
	/**
	 * Adds a set of conditional actions into the list of actions to perform if this block element
	 * is executed.
	 * 
	...
	/**
	 * Removes a set of conditional actions from the list of actions to perform if this block
	 * element is executed.
	 * 
	...
	public void writeWidget(ContentHandler outputHandler) throws NullPointerException, SAXException {
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_BLOCK, NAME_BLOCK, attributes);
		// Write the children.
