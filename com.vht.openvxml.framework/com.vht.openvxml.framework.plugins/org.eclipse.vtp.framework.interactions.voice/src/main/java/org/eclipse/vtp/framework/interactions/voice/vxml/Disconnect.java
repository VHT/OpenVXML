...
/**
 * The <code>Disconnect</code> class represents the &lt;disconnect&gt; VXML element. This action
 * will cause the VXML interpreter to disconnect the physical call and stop execution of the VXML
 * application.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
...
public class Disconnect extends Action {
	...
	public void writeWidget(ContentHandler outputHandler) throws NullPointerException, SAXException {
		...
		outputHandler
				.startElement(NAMESPACE_URI_VXML, NAME_DISCONNECT, NAME_DISCONNECT, attributes);
		outputHandler.endElement(NAMESPACE_URI_VXML, NAME_DISCONNECT, NAME_DISCONNECT);
	}
