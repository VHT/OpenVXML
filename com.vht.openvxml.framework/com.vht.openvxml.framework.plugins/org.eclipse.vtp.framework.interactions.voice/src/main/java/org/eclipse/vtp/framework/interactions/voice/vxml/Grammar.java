...
/**
 * The <code>Grammar</code> class represents the &lt;grammar&gt; VXML element. The grammar element
 * is used to designate the format of some input to be collected from the caller.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
 * @version 2.0
...
public class Grammar extends Widget implements VXMLConstants {
	 ...
	 */
	public Grammar(String mode) throws IllegalArgumentException, NullPointerException {
		setMode(mode);
	}
	...
	public void writeWidget(ContentHandler outputHandler) throws NullPointerException, SAXException {
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_GRAMMAR, NAME_GRAMMAR, attributes);
		// Write any children.
