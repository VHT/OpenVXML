...
/**
 * The <code>Goto</code> class represents the &lt;goto&gt; VXML element. This element causes the
 * VXML interpreter to stop execution of the current VXML document and begin executing the document
 * located at the target URI.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
 * @version 2.0
...
public class Goto extends Action {
	...
	/**
	 * Creates a new instance of <code>Goto</code> with the specified target URI.
	 * 
	 ...
	 */
	public Goto(String targetURI) throws IllegalArgumentException, NullPointerException {
		setTargetURI(targetURI);
	}

	/**
	 * Returns the URI of the next VXML document to process when this element is encountered by the
	 * VXML interpreter.
	 * 
	...
	/**
	 * Sets the URI of the next VXML document to process when this element is encountered by the
	 * VXML interpreter.
	 * 
	...
	public void writeWidget(ContentHandler outputHandler) throws NullPointerException, SAXException {
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_GOTO, NAME_GOTO, attributes);
