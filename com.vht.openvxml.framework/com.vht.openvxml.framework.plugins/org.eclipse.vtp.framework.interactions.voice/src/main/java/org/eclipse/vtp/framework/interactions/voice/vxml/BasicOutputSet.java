...
/**
 * The <code>OutputSet</code> class allows the combination of <code>Output</code>s into a single
 * output for the IVR to render to the caller. The outputs will be rendered in the order they are
 * added.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
...
public class BasicOutputSet extends BasicOutput {
	...
	/**
	 * Constructs a new instance of <code>OutputSet</code> whose list of outputs is initially empty.
	 */
	...
	/**
	 * Appends the <code>BasicOutput</code> to the list of outputs to render to the caller.
	 * 
	 * @param output The <code>BasicOutput</code> instance to append to the list.
	...
	/**
	 * Removes the <code>BasicOutput</code> from the list of outputs to render to the caller.
	 * 
	 * @param output The <code>BasicOutput</code> instance to remove from the list.
	 * @throws NullPointerException If the supplied action is <code>null</code>.
	 */
	 ...
	 */
	protected void writeOutputs(ContentHandler outputHandler) throws NullPointerException,
			SAXException {
