...
/**
 * The <code>Menu</code> class represents the &lt;menu&gt; VXML element. A menu is the counterpart
 * to the form element. Instead of the free-form nature of the form's field element, a menu provides
 * a set of choices that are typically selected with a single digit entry.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
 * @version 2.0
...
public class Menu extends Dialog {
	...
	/**
	 * Creates a new instance of <code>Menu</code> with the specified identifier and opening prompt.
	 * The set of properties and choices are initially empty. Throws an IllegalArgumentException if
	 * the prompt argument is <code>null</code>.
	 * 
	...
	/**
	 * Creates a new instance of <code>Menu</code> with the specified identifier, scope, and opening
	 * prompt. The set of properties and choices are initially empty. Throws an
	 * IllegalArgumentException if the prompt argument is <code>null</code>.
	 * 
	 * @param id See documentation of the Dialog element
	 ...
	 * @throws NullPointerException If the supplied prompt is <code>null</code>.
	 */
	public Menu(String id, String scope, Prompt prompt) throws IllegalArgumentException,
	...
	public void setPrompt(Prompt prompt) throws NullPointerException {
		if (prompt == null) { throw new NullPointerException("prompt"); //$NON-NLS-1$
		}
		this.prompt = prompt;
	}

	/**
	 * Adds the specified choice to this menu. The choices will be presented to the caller in the
	...
	public void addChoice(Choice choice) throws NullPointerException {
		if (choice == null) { throw new NullPointerException("choice"); //$NON-NLS-1$
		}
		choices.add(choice);
	}
	...
	public void writeWidget(ContentHandler outputHandler) throws NullPointerException, SAXException {
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_MENU, NAME_MENU, attributes);
		// Write the children.
	 ...
	 */
	protected void writeChoices(ContentHandler outputHandler) throws NullPointerException,
			SAXException {
