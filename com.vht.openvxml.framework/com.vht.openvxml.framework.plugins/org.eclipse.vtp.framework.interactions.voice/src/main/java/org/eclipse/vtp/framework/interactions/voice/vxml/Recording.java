...
public class Recording extends FormElement {
	 ...
	 * 
	 * @param name The name of the recording element.
	 * @param expression An expression that will set the initial value of the recording element.
	 * @throws IllegalArgumentException If the specified name is empty.
	 * @throws IllegalArgumentException If the specified expression is empty.
	 * @throws NullPointerException If the specified name is <code>null</code>.
	 */
	public Recording(String name, String expression) throws IllegalArgumentException,
	 ...
	 * @param name The name of the recording element.
	 * @param expression An expression that will set the initial value of the recording element.
	 * @param condition An expression that equates to a boolean value which determines if the
	...
	public void setMaxtime(String maxtime) throws IllegalArgumentException {
		if (maxtime != null && maxtime.length() == 0) { throw new IllegalArgumentException(
				"maxtime"); //$NON-NLS-1$
		}
	...
	public void setFinalSilence(String finalSilence) throws IllegalArgumentException {
		if (finalSilence != null && finalSilence.length() == 0) { throw new IllegalArgumentException(
				"finalSilence"); //$NON-NLS-1$
		}
	...
	public void setFileType(String fileType) throws IllegalArgumentException {
		if (fileType != null && fileType.length() == 0) { throw new IllegalArgumentException(
				"fileType"); //$NON-NLS-1$
		}
	...
	/**
	 * Adds the specified filled handler to this recording. The filled handlers will be executed in
	...
	public void writeWidget(ContentHandler outputHandler) throws NullPointerException, SAXException {
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_RECORD, NAME_RECORD, attributes);
		// Write the children.
	...
	protected void writeAttributes(AttributesImpl attributes) {
		...
		writeAttribute(attributes, null, null, NAME_BEEP, TYPE_CDATA, String.valueOf(beepEnabled));
		...
		if (finalSilence != null) {
			writeAttribute(attributes, null, null, NAME_FINALSILENCE, TYPE_CDATA, finalSilence);
		}
		if (fileType != null) {
