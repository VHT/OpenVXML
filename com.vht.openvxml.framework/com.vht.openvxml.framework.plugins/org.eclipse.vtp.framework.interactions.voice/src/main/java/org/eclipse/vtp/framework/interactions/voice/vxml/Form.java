...
/**
 * The <code>Form</code> class represents the &lt;form&gt; VXML element. A form can contain any
 * number of <code>Block</code> and <code>Field</code> elements. The child elements are presented to
 * the caller in the order they were added to the form.<br>
 * <br>
 * Instead of handling filled events within each field of the form, filled handlers can be added to
 * the form. This provides flexibility in the way a form is completed or progresses during
 * processing.<br>
 * <br>
 * Variables can be added at the form level. These variables are then accessible to all child
 * elements and are a convenient way to pass data from one child to another.
 * 
 * @author Trip Gilman
 * @author Lonnie Pryor
 * @version 2.0
...
public class Form extends Dialog {
	...
	/**
	 * Creates a new instance of <code>Form</code> with the specified identifier. The sets of form
	 * elements, variables, and filled handlers are initially empty.
	 * 
	...
	/**
	 * Creates a new instance of <code>Form</code> with the specified identifier and scope. The sets
	 * of form elements, variables, and filled handlers are initially empty.
	 * 
	 * @param id See documentation of the Dialog element.
	...
	/**
	 * Adds the specified variable element to this form. Variables declared at the form level are
	 * accessible to all child elements.
	 * 
	...
	/**
	 * Adds the specified form element to this form. Form elements will be processed in the order
	 * they were added.
	 * 
	...
	public void addFormElement(FormElement formElement) throws NullPointerException {
		if (formElement == null) { throw new NullPointerException("formElement"); //$NON-NLS-1$
		}
	...
	/**
	 * Adds the specified filled handler to this form. Filled handlers at the form level are
	 * processed when some or all of the form's child elements are set, depending on the mode of the
	 * handler. Filled handlers are executed in the order they were added.
	 * 
	...
	public void writeWidget(ContentHandler outputHandler) throws NullPointerException, SAXException {
		...
		outputHandler.startElement(NAMESPACE_URI_VXML, NAME_FORM, NAME_FORM, attributes);
		// Write the children.
	 ...
	 */
	protected void writeFormElements(ContentHandler outputHandler) throws NullPointerException,
			SAXException {
