...
public class Transfer extends FormElement {
	 ...
	 */
	public Transfer(String name, String destination) throws IllegalArgumentException,
	 ...
	 * @throws NullPointerException If the specified destination is <code>null</code>.
	 */
	public Transfer(String name, String expression, String condition, String destination)
			throws IllegalArgumentException, NullPointerException {
