...
public interface IExecutionDescriptor {
	...
	/**
	 * Returns the value of the parameter with the specified name or <code>null</code> if no such
	 * parameter exists.
	 * 
	 * @param parameterName The name of the parameter to return.
	 * @return The values of the parameter with the specified name or <code>null</code> if no such
	 *         parameter exists.
	 * @throws NullPointerException If the specified parameter name is <code>null</code>.
	 */
	String getParameter(String parameterName) throws NullPointerException;

	/**
	 * Returns the values of the parameter with the specified name or <code>null</code> if no such
	 * parameter exists.
	 * 
	 * @param parameterName The name of the parameter to return.
	 * @return The values of the parameter with the specified name or <code>null</code> if no such
	...
	/**
	 * Sets the value of the parameter with the specified name or clears it if the value is
	 * <code>null</code>.
	 * 
	 * @param parameterName The name of the parameter to set.
	 * @param value The value of the parameter with the specified name or <code>null</code> to clear
	 *            the value.
	 * @throws NullPointerException If the supplied parameter name is <code>null</code>.
	 */
	void setParameter(String parameterName, String value) throws NullPointerException;

	/**
	 * Sets the values of the parameter with the specified name or clears them if the value is
	 * <code>null</code> or empty.
	 * 
	 * @param parameterName The name of the parameters to set.
	 * @param values The values of the parameter with the specified name or <code>null</code> or to
	 *            clear the values.
	 * @throws NullPointerException If the supplied parameter name is <code>null</code>.
	 */
	void setParameters(String parameterName, String[] values) throws NullPointerException;
