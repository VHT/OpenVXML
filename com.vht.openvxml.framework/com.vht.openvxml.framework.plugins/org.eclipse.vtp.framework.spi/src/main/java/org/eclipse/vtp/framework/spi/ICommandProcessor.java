...
/**
 * A service provided by the process controller that accepts commands issued from components of the
 * process.
 * 
 * @author Lonnie Pryor
 */
public interface ICommandProcessor {
	...
	/**
	 * Attempts to enqueue the specified command for execution by the process controller and then
	 * waits for all commands in the queue to be processed before returning.
	 * 
	 * @param command The command to enqueue.
